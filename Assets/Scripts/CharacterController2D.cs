...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        //Permite pulo duplo quando estiver no chao
		...
		{
            doJump();
		} else if (canDoubleJump && Input.GetButtonDown("Jump")) { //Se puder dar poulo duplo e o botao de pulo estiver pressionado, permitir pulo duplo.
            doJump();
            canDoubleJump = false; //Desabilita o pulo duplo depois de um pulo duplo
        }
